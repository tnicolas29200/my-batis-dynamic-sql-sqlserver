...
import static org.mybatis.dynamic.sqlserver.SQLServerBuilder.coalesce;
import static org.mybatis.dynamic.sqlserver.SQLServerBuilder.currentUser;
import static org.mybatis.dynamic.sqlserver.SQLServerBuilder.isDate;
import static org.mybatis.dynamic.sqlserver.SQLServerBuilder.isNull;
import static org.mybatis.dynamic.sqlserver.SQLServerBuilder.isNumeric;
import static org.mybatis.dynamic.sqlserver.SQLServerBuilder.nullIf;
import static org.mybatis.dynamic.sqlserver.SQLServerBuilder.userName;
import static org.mybatis.dynamic.sqlserver.SQLServerBuilder.systemUser;
import static org.mybatis.dynamic.sqlserver.SQLServerBuilder.sessionUser;
import static org.mybatis.dynamic.sqlserver.SQLServerBuilder.sessionProperty;
...
public class SystemFunctionsTest {
    ...
    public void testCoalesce() {
        test(select(coalesce(columnString1, columnString2).as("A_COLUMN1")).from(table, "a").where(coalesce(columnString1, columnString2), isEqualTo("ABC")),
        	"select COALESCE(a.columnString1, a.columnString2) as A_COLUMN1 from foo a where COALESCE(a.columnString1, a.columnString2) = #{parameters.p1,jdbcType=OTHER}");
    }
