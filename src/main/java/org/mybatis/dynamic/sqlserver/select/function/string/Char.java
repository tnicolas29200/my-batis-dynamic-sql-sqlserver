...
public class Char extends AbstractFunction<Integer, Char> {
    
    private Char(BindableColumn<Integer> column) {
        super(column);
    }
    ...
    @Override
    protected Char copy() {
        return new Char(column);
    }
    
    public static Char of(BindableColumn<Integer> column) {
        return new Char(column);
    }
